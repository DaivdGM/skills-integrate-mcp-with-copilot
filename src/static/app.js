document.addEventListener("DOMContentLoaded", () => {
  ...
  const signupAuthRequired = document.getElementById("signup-auth-required");
  ...
  function updateAuthUI() {
    if (isTeacherAuthenticated) {
      ...
      signupAuthRequired.classList.add("hidden");
    } else {
      authStatusText.textContent = "Not logged in";
      openLoginBtn.classList.remove("hidden");
      logoutBtn.classList.add("hidden");
      signupForm.classList.add("hidden");
      signupAuthRequired.classList.remove("hidden");
    }
  }
  ...
  async function refreshAuthStatus() {
    ...
    try {
      ...
      isTeacherAuthenticated = Boolean(result.authenticated);
  ...
  async function fetchActivities() {
    try {
      ...
      // Reset options before repopulating.
